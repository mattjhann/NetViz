    ...
    <>
      <header className="hero">
        ...
        <motion.p className="hero__lede" {...rise(0.24)}>
          ...
          network can reach which addresses. Scroll to watch a route propagate between
          Autonomous Systems, a best path get chosen, a link fail — and BGP reroute around it.
        </motion.p>
